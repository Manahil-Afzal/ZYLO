...
userRouter.put("/update-user", user_controller_1.updateAccessToken, auth_1.isAuthenticated, user_controller_1.updateUserRole);
userRouter.post("/add-member", user_controller_1.updateAccessToken, auth_1.isAuthenticated, (0, auth_1.authorizeRoles)("admin"), user_controller_1.addTeamMember);
