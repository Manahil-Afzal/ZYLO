...
courseRouter.get("/get-course", course_controller_1.getAllCourses);
...
courseRouter.put("/add-reply", user_controller_1.updateAccessToken, auth_1.isAuthenticated, course_controller_1.addReplyToReview);
courseRouter.get("/get-courses", auth_1.isAuthenticated, (0, auth_1.authorizeRoles)("admin"), course_controller_1.getAllCourses);
