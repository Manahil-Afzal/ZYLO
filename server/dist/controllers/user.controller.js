...
const createActivationToken = (user) => {
    ...
    const activationTokenExpiresIn = (process.env.ACTIVATION_TOKEN_EXPIRES_IN || "15m");
...
exports.getUserInfo = (0, catchAsyncErrors_1.CatchAsyncError)(async (req, res, next) => {
    try {
        ...
        (0, user_service_1.getUserById)(userId.toString(), res);
    }
    catch (error) {
        return next(new ErrorHandler_1.default(error.message, 400));
    }
...
exports.addTeamMember = (0, catchAsyncErrors_1.CatchAsyncError)(async (req, res, next) => {
    try {
        ...
        if (!["admin", "user"].includes(role)) {
            return next(new ErrorHandler_1.default("Role must be admin or user", 400));
        }
