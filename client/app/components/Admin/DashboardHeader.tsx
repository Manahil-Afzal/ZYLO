  ...
  return (
    ...
    <div className="w-full flex items-center justify-end p-4 800px:p-6 fixed top-0 800px:top-5 right-0 z-[9999999]">
      ...
      {open && (
        ...
        <div className="w-[90vw] 800px:w-[350px] h-[50vh] 800px:h-[60vh] overflow-y-auto py-3 px-2 border border-[#ffffff0c] dark:bg-[#111C43] bg-white shadow-2xl absolute top-16 right-2 800px:right-0 z-[10000000] rounded-lg">
